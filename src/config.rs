...
pub struct DeviceDef {
    ...
    pub synwait: u16,
    #[serde(default = "default_min_label_feed_lines")]
    pub min_label_feed_lines: u16,
}
...
fn default_min_label_feed_lines() -> u16 {
    FEED_LINES_FOR_CUT * 3
}
...
fn default_device() -> DeviceDef {
    DeviceDef {
        ...
        dpi: 180,
        synwait: 64,
        min_label_feed_lines: FEED_LINES_FOR_CUT * 3,
    }
}
